...
public class ReceiveTopic02 {
    ...
    private static final String QUQUE_NAME="Q2";
    ...
    public static void main(String[] args) throws Exception{
        ...
        channel.queueBind(QUQUE_NAME,EXCHANGE_NAME,"lazy.#.*");
        channel.queueBind(QUQUE_NAME,EXCHANGE_NAME,"*.*.rabbit*");
        System.out.println("ReceiveTopic02等待接收消息，把接收的消息打印在屏幕上.......");

        DeliverCallback deliverCallback02 = (consumerTag, message) ->{
         ...
         * 4. 消费着取消消费的回调
         * */
        channel.basicConsume(QUQUE_NAME,false,deliverCallback02,consumerTag->{});
